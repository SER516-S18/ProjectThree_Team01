...
public class EmotivDataTest {
  ...
  public EmotivDataTest(JSONObject jsonObject) {
  ...
  public EmotivDataTest(JSONObject expressive, JSONObject affective) {
